...
<div class="card">
    <div class="card-body">
        <a href="/kegiatanharian4/create" class="btn btn-primary btn-sm my-3">Tambah Kegiatan</a>
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    @forelse ($kegiatanharian4 as $key=>$value)
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <a href="filekegiatanharian4/{{$value->bukti_kegiatan}}">{{$value->bukti_kegiatan}}</a>
                        </td>
                        <td>
                            <form action="/kegiatanharian4/{{$value->id}}" method="POST" id="form-delete">
                                @method('delete')
                                @csrf
                                <a href="/kegiatanharian4/{{$value->id}}/edit" class="btn btn-warning btn-sm mb-2">Edit</a>
                                <button type="submit" id="show_confirm" class="btn btn-xs btn-danger btn-flat show_confirm" data-toggle="tooltip" title='Delete'>Delete</button>
